      ...
      <Box sx={{
        ...
        <Box sx={{
          ...
          <Box sx={{ display: 'flex', alignItems: "center", gap: 1 }}>
            ...
            <Typography variant="subtitle1">+91 9027881144</Typography>
          </Box>

          <Box sx={{ display: 'flex', alignItems: "center", gap: 1 }}>
            <EmailIcon sx={{ fontSize: 24 }} />
            <Typography variant="subtitle1">chaudhary2001shubham@gmail.com</Typography>
          </Box>

          <Box sx={{ display: 'flex', alignItems: "center", gap: 1 }}>
            <LocationPinIcon sx={{ fontSize: 24 }} />
            <Typography variant="subtitle1">Agra, U.P, India</Typography>
          </Box>
        </Box>
